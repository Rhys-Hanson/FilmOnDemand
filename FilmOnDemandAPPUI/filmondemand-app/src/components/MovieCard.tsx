          ...
          <div className="flex items-end justify-between gap-3">
            <div className="flex-1 min-w-0">
              ...
              {movie.streamingServices && movie.streamingServices.length > 0 && (
                <p className="mt-2 text-sm text-neutral-200/90 font-medium line-clamp-2">
                  Watch on {movie.streamingServices.join(', ')}
                </p>
              )}
            </div>
            <button
              ...
              className="w-10 h-10 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center text-white border border-white/30 active:scale-95 transition-transform shrink-0"
            >
