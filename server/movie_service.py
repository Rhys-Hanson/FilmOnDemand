        ...
        normalized_movies.append(
            {
                ...
                "description": movie.get("description") or movie.get("summary") or "No description available.",
                "cast": cast_names,
                "castList": cast_list,
                "rtScore": rt_score,
                ...
                "imdbScoreSource": movie.get("imdbScoreSource") or "omdb",
                "rtScoreSource": movie.get("rtScoreSource") or "omdb",
                "metacriticScoreSource": movie.get("metacriticScoreSource") or "omdb",
                "traktRating": movie.get("traktRating") or 0,
                "traktVotes": movie.get("traktVotes") or 0,
                "summary": movie.get("description") or movie.get("summary") or "No summary available.",
                "genre": movie.get("genres") or movie.get("genre") or [],
                "year": movie.get("year"),
